...
export abstract class GeneralLedgerReport extends Report {
  ...
  async _setRawData() {
    ...
    const fields = [
      ...
      'reverted',
      'party',
      'account', // Ensure account field is included
      'date',
      'debit',
      'credit',
      'referenceType',
    ...
    this._rawData = entries.map((entry) => {
      return {
        ...
        account: entry.account, // Ensure account is set
        ...
        //originalBalance: 0, // Initialize the original balance to 0

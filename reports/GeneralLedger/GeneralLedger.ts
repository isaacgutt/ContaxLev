...
export class GeneralLedger extends GeneralLedgerReport {
  ...
  async setReportData(filter?: string, force?: boolean) {
    ...
    // Ensure this method is called to calculate balances
  ...
  getColumns(): ColumnField[] {
    let columns = [
      ...
      {
        label: t`Total Balance`, // New column for total balance
        fieldtype: 'Currency',
